...
async def db_engine():
    ...
    async with admin_engine.connect() as conn:
        ...
        test_db_name = f"customer_service_test"
...
@pytest_asyncio.fixture(loop_scope="session", scope="function")
async def customer_service(db_session) -> AsyncGenerator[CustomerService, None]:
    events_save_service = OutboxSaveService(db_session)

    service = CustomerService(db_session, events_save_service)
    yield service